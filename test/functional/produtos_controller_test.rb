...
class ProdutosControllerTest < ActionController::TestCase
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post :create, produto: { pdescri: @produto.pdescri, pimg: @produto.pimg, pnome: @produto.pnome, pvalor: @produto.pvalor }
    end
  ...
  test "should update produto" do
    put :update, id: @produto, produto: { pdescri: @produto.pdescri, pimg: @produto.pimg, pnome: @produto.pnome, pvalor: @produto.pvalor }
    assert_redirected_to produto_path(assigns(:produto))
  end
